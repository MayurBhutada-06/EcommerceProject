...
public class ProductOrder {
	...
	public void accountCreation() {
		...
		driver.findElement(By.xpath("(//a[@href='http://automationpractice.com/index.php?controller=my-account'])[1]"))
				.click();
		driver.findElement(By.id("email_create")).sendKeys("jbhutada61@gmail.com");
		...
		driver.findElement(By.id("passwd")).sendKeys("Jaigajanan@41");
	...
	public void loginToAccount() {
		...
		driver.findElement(By.xpath("(//a[@href='http://automationpractice.com/index.php?controller=my-account'])[1]"))
				.click();
		driver.findElement(By.id("email")).sendKeys("jbhutada61@gmail.com");
		driver.findElement(By.id("passwd")).sendKeys("Jaigajanan@41");
